    ...
    return (
        <div className=" ">
            ...
            <div className="container h-full relative">
                <div className=" grid xl:grid-cols-2 gap-5 w-full items-start xl:justify-between absolute top-10">
                    <div className="formtext bg-white w-full p-3 rounded-md mb-12">
                        <p className="text-center font-bold">
                            {name.toUpperCase()} FRONT PAGE
                        </p>
                            ...
                            <form>
                                <div className="mb-11 text-center flex flex-col items-center gap-6">
                                    <div>
                                        <div
                                            ...
                                            ta="center"
                                            mt="sm"
                                            className="w-[10rem] h-[10rem] border overflow-hidden"
                                        >
                                            <img
                                                src={
                                                    file ? file : instituteLogo
                                                }
                                        ...
                                        {content.map((data, i) => (
                                            <div key={i}>
                                                ...
                                                <div className="md:grid grid-cols-3 gap-2 items-center justify-center">
                                                    ...
                                                    />
                                                    <datalist
                                                        id={`studentDepartment${data}`}
                                                    >
                                                        {datas.department.map(
                                                            (data, i) => (
                                                                <option
                                                                    key={i}
                                                                    value={data}
                                ...
                                <div className="mt-3">
                                    <Chip
                                        variant="filled"
                                        checked={subchecked}
                                        onChange={(v) => handleDateInclude(v)}
                                        value={
                                            subchecked
                                                ? "Submission Date Included"
                                                : "Submission date not included"
                                        }
                                    >
                                        {subchecked
                                            ? "Submission Date Included"
